 ...
 * Altered by Jonathan Cole / Tim Cole for use with ScreenLab 2016
 *
 * LATEST UPDATES
 *
 * -----------------------------
 ...
 * -----------------------------
 ...
 JustGage = function(config) {
  ...
  obj.config =
  {
    ...
    // titleLabel : string (tscole addition)
    // if set replace the value with this string
    titleLabel : obj.kvLookup('titleLabel', config, dataset, ''),

	// titleLabel2 : string (tscole addition)
    // a second label in place of value
    titleLabel2 : obj.kvLookup('titleLabel2', config, dataset, ''),
  ...
  // second value (added by tscole for screenlab)
  obj.txtValue2 = obj.canvas.text(obj.params.valueX, obj.params.valueY, 0);
  obj.txtValue2.attr({
    "font-size":obj.params.valueFontSize,
    "font-weight":"bold",
    "font-family":"Arial",
  ...
  setDy(obj.txtValue2, obj.params.valueFontSize, obj.params.valueY);  
  ...
  if(obj.config.titleLabel != '') {
  	obj.originalValue = obj.config.titleLabel;
  }
  ...
  if(obj.config.counter === true) {
    ...
    eve.on("raphael.anim.finish." + (obj.level.id), function() {
      obj.txtValue.attr({"text" : obj.config.titleLabel});
      setDy(obj.txtValue, obj.params.valueFontSize, obj.params.valueY);
     // obj.txtValue2.attr({"text" : obj.config.titleLabel2});
     // setDy(obj.txtValue2, obj.params.valueFontSize, obj.params.valueY);
    });
  } else {
    //on animation start
  ...
  obj.txtValue2.animate({"fill-opacity":"1"}, obj.config.startAnimationTime, obj.config.startAnimationType);
